...
static void *video_logo(void)
{
	...
	//printf("checking splashimage variable %s.... \n", s);


	//if (s != NULL) {
		splash_screen_prepare();
		//addr = simple_strtoul(s, NULL, 16);
		addr = simple_strtoul("0x97c90000", NULL, 16);

		printf("loading booting logo at /boot/bootsplash.bmp .... \n");
		/* memcpy((char *)addr, (char *)boot_bmp, boot_bmp_size);*/

		fs_argv[0] = "ext2load";
		fs_argv[1] = "mmc";
		fs_argv[2] = "0";
		fs_argv[3] = "97c90000";
		fs_argv[4] = "/boot/bootsplash.bmp";
		...
		{
			printf("Boot Logo /boot/bootsplash.bmp not exist...\n");
		}
	//}
